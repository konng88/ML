...
class ImgEmb(Layer):
    def __init__(self, batch_size, output_D):
        ...
        tf.keras.backend.set_floatx('float32')
    def build(self, input_shape):
        self.conv1 = Conv2D(12,kernel_size=3,padding='same')
        self.bn1 = BatchNormalization()
        self.conv2 = Conv2D(24,kernel_size=3,padding='same')
        self.bn2 = BatchNormalization()
        self.mp1 = MaxPool2D()
        self.drop1 = Dropout(0.25)
        self.conv3 = Conv2D(48,kernel_size=3,padding='same')
        self.bn3 = BatchNormalization()
        self.conv4 = Conv2D(96,kernel_size=3,padding='same')
        self.bn4 = BatchNormalization()
        self.mp2 = MaxPool2D()
        self.drop2 = Dropout(0.25)
        self.conv5 = Conv2D(192,kernel_size=3,padding='same')
        self.bn5 = BatchNormalization()
        self.conv6 = Conv2D(192*2,kernel_size=3,padding='same')
